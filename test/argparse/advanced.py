...
def cli():
	...
	parser.add_argument("positional-file", type=argparse.FileType('r'), help="positional arg for a file")
	...
	parser.add_argument("--choices", action="store", choices=["choice1", "choice2"], help="optional arg store with choices")
	...
	mxg.add_argument("--mxg-choices", action="store", choices=["choice1", "choice2"], help="mutually exclusive arg store with choices")
